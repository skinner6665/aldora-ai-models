...
MODELS = [
    ...
    ("models/preeclampsia_gbm.onnx",          "PREECLAMPSIA_ONNX_ID"),
    ("models/mortality_gbm.onnx",             "MORTALITY_ONNX_ID"),
    ("models/readmissao_gbm.onnx",            "READMISSAO_ONNX_ID"),
    ("models/deterioracao_gbm.onnx",          "DETERIORACAO_ONNX_ID"),
    ("models/vitaldb_ihi_v2.onnx",            "VITALDB_ONNX_ID"),
    ("models/eeg_epilepsy_combined_gbm.onnx", "EEG_ONNX_ID"),
    ("models/circor_cardiac_gbm.onnx",        "CIRCOR_ONNX_ID"),
    ("models/lung_sound_ensemble.onnx",       "LUNG_ONNX_ID"),
